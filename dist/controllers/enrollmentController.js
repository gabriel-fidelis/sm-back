...
var enrollmentController = /** @class */ (function () {
    ...
    enrollmentController.getEnrollments = function () {
        return __awaiter(this, void 0, void 0, function () {
            var enrollments;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.enrollmentDAO.getEnrollments().then(function (foundEnrollments) {
    ...
    enrollmentController.enrollStudent = function (object) {
        return __awaiter(this, void 0, void 0, function () {
            var enrollment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.enrollmentDAO.enrollStudent(object).then(function (createdEnrollment) {
