...
var studentDAO_1 = require("../dao/studentDAO");
var StudentController = /** @class */ (function () {
    function StudentController() {
    }
    StudentController.getStudents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var studentsResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._studentDAO.getStudents().then(function (students) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, studentsResult];
                }
            });
        });
    };
    ...
    StudentController.createStudent = function (object) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._studentDAO.insertStudent(object).then(function (createdStudent) {
    ...
    StudentController._studentDAO = new studentDAO_1.StudentDAO();
